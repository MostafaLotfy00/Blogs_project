            ...
            <ul class="nav navbar-nav menu_nav justify-content-center">
              ...
              <li class="nav-item @yield('category-active') submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="nav-item @yield('category-active') "><a class="nav-link" href="{{ route('theme.category') }}">Food</a></li>
                  <li class="nav-item @yield('category-active')"><a class="nav-link" href="{{ route('theme.category') }}">Bussiness</a></li>
                  <li class="nav-item @yield('category-active')"><a class="nav-link" href="{{ route('theme.category') }}">Travel</a></li>
                </ul>
              </li>
