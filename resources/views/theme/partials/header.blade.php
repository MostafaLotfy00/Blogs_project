                             ...
                             <li class="nav-item submenu dropdown">
                                 ...
                                 <ul class="dropdown-menu">
                                     ...
                                     <form id="myForm" action="{{ route('logout') }}" method="post">
                                        @csrf
                                       <li class="nav-item">  <a href="#"  class="nav-link" onclick="document.getElementById('myForm').submit(); return false;">log out</a></li>
                                     </form>

                                     {{-- <li class="nav-item"><a href="#" class="nav-link"
                                             onclick="document.getElementById('myForm').submit(); return false;">
                                             log out</a></li> --}}
                                     {{-- <li class="nav-item"><a class="nav-link" href="blog-details.html">log out</a></li> --}}
                                 </ul>
                             </li>
                         @endif
                     </ul>
